...
export function normalizeTitleForEmbedding(
  ...
  text = text
    ...
    .replace(/\bteam to advance\b/gi, "advance winner")
    .replace(/\bo\/u\b|\bover\/under\b/gi, "total line")
    .replace(/\bvs\.?\b|\bversus\b/gi, " vs ")
    .replace(/\bsouth africa\b/gi, "rsa south africa")
    .replace(/\bcanada\b/gi, "can canada")
